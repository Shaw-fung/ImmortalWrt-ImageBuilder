...
# 新增passwall2 apk (注意: passwall2目前仅有ipk格式,25.12的apk无法安装,待RunFilesBuilder提供apk包后取消注释)
...
# 新增 clashoo by kenzok8 注意若集成clashoo 则不能集成nikki 目前它们俩配置冲突 (clashoo目前仅有ipk格式,25.12的apk无法安装)
