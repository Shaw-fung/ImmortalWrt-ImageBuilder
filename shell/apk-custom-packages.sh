...
# 分区扩容 by sirpdboy (luci-app-partexp 和 luci-i18n-partexp-zh-cn 暂不在25.12 apk仓库中, 请勿启用)
#CUSTOM_PACKAGES="$CUSTOM_PACKAGES luci-app-partexp luci-i18n-partexp-zh-cn"
# 流量监控 by timsaya
#CUSTOM_PACKAGES="$CUSTOM_PACKAGES bandix luci-app-bandix luci-i18n-bandix-zh-cn"
# 新增ssrp apk (luci-app-ssr-plus 和 luci-i18n-ssr-plus-zh-cn 暂不在25.12 apk仓库中, 请勿启用)
...
# 新增passwall2 apk (RunFilesBuilder已提供apk格式,文件名已修复)
...
# 新增 clashoo by kenzok8 注意若集成clashoo 则不能集成nikki 目前它们俩配置冲突 (RunFilesBuilder已提供apk格式,文件名已修复)
CUSTOM_PACKAGES="$CUSTOM_PACKAGES clashoo luci-app-clashoo luci-i18n-clashoo-zh-cn"
# 新增 Lucky大吉 by gdy666 & sirpdboy 
#CUSTOM_PACKAGES="$CUSTOM_PACKAGES luci-app-lucky lucky luci-i18n-lucky-zh-cn"
# daed 升级到1.28.0 (luci-i18n-daed-zh-cn暂不在25.12 apk仓库中)
